...
public interface ProjectDependencyConfig {
    ...
    /**
     * @return a directory where Domino will clone git repositories and other related data to be able to reuse them
     *         on next invocations or {@code null} if an ephemeral temporary directory should be used.
     */
    String getGitCloneDir();
    ...
    interface Mutable extends ProjectDependencyConfig {
        ...
        Mutable setGitCloneDir(String dir);
